            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.commandes.show', $commande->idCommande) }}" class="btn-view" onclick="event.preventDefault(); viewCommande({{ $commande->idCommande }});">
...
function viewCommande(id) {
    // Utiliser adminFetchAndInject pour charger la vue partielle
    const url = `/admin/commandes/${id}`;
    if(window.adminFetchAndInject){
        window.adminFetchAndInject(url);
    } else {
        // Fallback si adminFetchAndInject n'est pas disponible
